package com.eollse.zxt.flipview.flipview;

import android.opengl.GLSurfaceView;
import android.opengl.GLU;
import android.view.View;

import com.eollse.zxt.flipview.flipview.utils.AphidLog;
import com.eollse.zxt.flipview.flipview.utils.TextureUtils;
...
public class FlipRenderer implements GLSurfaceView.Renderer {
  ...
  private com.eollse.zxt.flipview.flipview.FlipViewController flipViewController;

  private com.eollse.zxt.flipview.flipview.FlipCards cards;

  private boolean created = false;

  private final LinkedList<com.eollse.zxt.flipview.flipview.Texture> postDestroyTextures = new LinkedList<com.eollse.zxt.flipview.flipview.Texture>();

  public FlipRenderer(com.eollse.zxt.flipview.flipview.FlipViewController flipViewController, com.eollse.zxt.flipview.flipview.FlipCards cards) {
  ...
  public void onSurfaceCreated(GL10 gl, EGLConfig config) {
    ...
    flipViewController.sendMessage(com.eollse.zxt.flipview.flipview.FlipViewController.MSG_SURFACE_CREATED);
  ...
  public void onDrawFrame(GL10 gl) {
    ...
    synchronized (postDestroyTextures) {
      for (com.eollse.zxt.flipview.flipview.Texture texture : postDestroyTextures) {
        texture.destroy(gl);
      }
  ...
  public void postDestroyTexture(com.eollse.zxt.flipview.flipview.Texture texture) {
    synchronized (postDestroyTextures) {
