...
import com.eollse.zxt.flipview.flipview.utils.UI;
    ...
    public synchronized boolean handleTouchEvent(MotionEvent event, boolean isOnTouchEvent) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                //x的范围
                float re=Math.abs(event.getX()-firstX);
                if (re<200){
                    return false;
                }
                ...
                if (state == STATE_TOUCH) {
                    ...
                    */
                    ...
                    controller.getSurfaceView().requestRender();
                    Log.e("test ","flipcards return true");
                    return true;
                }
                Log.e("test ","flipcards isOnTouchEvent"+isOnTouchEvent);
                return isOnTouchEvent;
